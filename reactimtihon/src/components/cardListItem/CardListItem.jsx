...
export const CardListItem = (props) => {
  const { img, title, author, createdAt, rate, like, changeLike, id } = props
      ...
      <div className={s["card-list-item-wrapper"]}>
        <div className={s["card-list-item-content"]}>
          ...
          <div className={s["btns"]}>
            <NavLink to={`/home/${id}`}>Info</NavLink>
            <Link href="#">Read</Link>
          </div>
        </div>
      </div>
